...
#if defined(GD32F330xB)
#define FLASHSIZE                       0x20000 // 128K
#else
...
// Battery driver
  ...
  // Ni-MH 1.2V x 4
  #define BATTERY_WARN                  44
  #define BATTERY_MIN                   40
  #define BATTERY_MAX                   60
#else
  // NI-MH 7.2V
...
// BATT_SCALE should not be used (VBAT_DIV_R1 VBAT_DIV_R2 instead)
#if defined(PCBXLITE)
