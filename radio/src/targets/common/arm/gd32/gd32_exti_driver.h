...
typedef void (*gd32_exti_handler_t)();
...
// Set callback and enable IRQ
void gd32_exti_custom_enable(exti_line_enum line, exti_trig_type_enum trigger, gd32_exti_handler_t cb);

// Reset callback and disable IRQ if no more handlers
void gd32_exti_custom_disable(exti_line_enum line);

// trigger software interrupt
void gd32_exti_custom_trigger_swi(exti_line_enum line);
